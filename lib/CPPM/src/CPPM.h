...
#define CPPM_ICP1 20 // Input Capture Pin of Arduino UNO is pin 8 - ICP1 (Atmega328 PB0)
#define CPPM_OC1A 19 // Output Compare Pin of Arduino UNO is pin 9 - OC1A (Atmega328 PB1)
